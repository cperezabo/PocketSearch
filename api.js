var API = {
    ...
    add: function(url) {
        ...
        return API.call('add', data).then(function(data) {
            return data.item;
        });
    },
...
var Auth = {
    consumerKey: '54218-89fbabf091651d684764cbc6',
    redirectUri: chrome.extension.getURL('authorized.html'),
     ...
     * @param requestTok  en A request token, as produced by getRequestToken.
